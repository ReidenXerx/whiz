...
This project is indexed by GitNexus as **whiz** (2830 symbols, 6588 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the WhizKitTests area (59 symbols) | `.claude/skills/generated/whizkittests/SKILL.md` |
...
| Work in the Cluster_68 area (5 symbols) | `.claude/skills/generated/cluster-68/SKILL.md` |
